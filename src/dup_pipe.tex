...
\node[draw,left= .25cm of c1.west,code] (x)  {
    \begin{lstlisting}
close(fd[1]);
    \end{lstlisting}
};
\node[draw,left= .25cm of d1.west,code] (w) {
    \begin{lstlisting}
dup2(fd[0],0);
    \end{lstlisting}
};
\node[draw,left= .25cm of e1.west,code] (x)  {
    \begin{lstlisting}
close(fd[0]);
     \end{lstlisting}
};
...
\node[draw,right= .25cm of c2.east,code] (x)  {
    \begin{lstlisting}
close(fd[0]);
    \end{lstlisting}
};
\node[draw,right= .25cm of d2.east,code] (w) {
    \begin{lstlisting}
dup2(fd[1],1);
    \end{lstlisting}
};
\node[draw,right= .25cm of e2.east,code] (x)  {
    \begin{lstlisting}
close(fd[1]);
     \end{lstlisting}
};
