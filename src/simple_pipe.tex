...
%Tables
\node (table1)[below= 1cm of child12] {
...
\node (table3)[below= 1cm of child32] {
\begin{tabular}{r | >{\centering\arraybackslash}p{1.1cm}  | l}\cline{2-2}
...
($(child1.north west)+(-0.3,1)$)  rectangle ($(table1.south east)+(0.3,-0.4)$);
\path[fill=blue!20,rounded corners]
($(child2.north west)+(-0.3,1)$)  rectangle ($(table2.south east)+(0.3,-0.4)$);
\path[fill=blue!20,rounded corners]
($(child3.north west)+(-0.3,1)$)  rectangle ($(table3.south east)+(0.3,-0.4)$);
%Parent
